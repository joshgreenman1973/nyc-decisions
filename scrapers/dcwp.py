"""DCWP (Department of Consumer and Worker Protection) Final Agency Decisions.

Page: /site/dca/about/Final-Agency-Decisions.page
"""
...
SOURCE = "dcwp"
INDEX_URL = "https://www.nyc.gov/site/dca/about/Final-Agency-Decisions.page"
DATE_RE = re.compile(
    ...
    with B.http_client() as client:
        ...
        for a in tree.css("a"):
            ...
            if not href.lower().endswith(".pdf"):
                continue
            if "/dca/" not in href and "/dcwp/" not in href:
                continue
            if href.startswith("/"):
            ...
            rec = B.Record(
                ...
                title=f"DCWP final decision: {title}"[:280],
                decision_date=date,
